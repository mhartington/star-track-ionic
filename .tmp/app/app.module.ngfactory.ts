...
import * as import37 from 'ionic-angular/components/modal/modal';
import * as import38 from 'ionic-angular/components/picker/picker';
import * as import39 from 'ionic-angular/components/popover/popover';
import * as import40 from 'ionic-angular/components/tap-click/tap-click';
import * as import41 from 'ionic-angular/components/toast/toast';
import * as import42 from 'ionic-angular/translation/translate';
import * as import43 from 'ionic-angular/transitions/transition-controller';
import * as import44 from '../providers/spotify-service/spotify-service';
import * as import45 from '../providers/native-media/native-media';
...
import * as import56 from '../pages/favorite/favorite.ngfactory';
import * as import57 from '../pages/menu/menu.ngfactory';
import * as import58 from '../pages/results/results.ngfactory';
import * as import59 from '../pages/search/search.ngfactory';
import * as import60 from '../pages/track-detail/track-detail.ngfactory';
...
import * as import64 from '@angular/platform-browser/src/dom/events/hammer_gestures';
...
import * as import67 from './app.component';
...
import * as import70 from 'ionic-angular/navigation/url-serializer';
import * as import71 from 'ionic-angular/navigation/deep-linker';
import * as import72 from 'ionic-angular/platform/query-params';
import * as import73 from 'ionic-angular/platform/platform-registry';
import * as import74 from 'ionic-angular/platform/platform';
import * as import75 from 'ionic-angular/config/config';
import * as import76 from 'ionic-angular/config/mode-registry';
import * as import77 from 'ionic-angular/transitions/transition-registry';
...
import * as import89 from 'ionic-angular/components/app/app-root';
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __GestureController_59:import32.GestureController;
  __Keyboard_60:import33.Keyboard;
  __LoadingController_61:import34.LoadingController;
  __LocationStrategy_62:any;
  __Location_63:import35.Location;
  __MenuController_64:import36.MenuController;
  __ModalController_65:import37.ModalController;
  __PickerController_66:import38.PickerController;
  __PopoverController_67:import39.PopoverController;
  __TapClick_68:import40.TapClick;
  __ToastController_69:import41.ToastController;
  __Translate_70:import42.Translate;
  __TransitionController_71:import43.TransitionController;
  __UrlSerializer_72:any;
  __DeepLinker_73:any;
  __SpotifyService_74:import44.SpotifyService;
  __NativeMedia_75:import45.NativeMedia;
  constructor(parent:import46.Injector) {
    super(parent,[
      ...
      import55.MyAppNgFactory,
      import56.FavoritePageNgFactory,
      import57.MenuPageNgFactory,
      import58.ResultsPageNgFactory,
      import59.SearchPageNgFactory,
      import60.TrackDetailPageNgFactory,
      import49.IonicAppNgFactory
    ]
    ,[import49.IonicAppNgFactory]);
  }
  ...
  get _APP_ID_29():any {
    if ((this.__APP_ID_29 == (null as any))) { (this.__APP_ID_29 = import61._appIdRandomProviderFactory()); }
  ...
  get _EVENT_MANAGER_PLUGINS_32():any[] {
    if ((this.__EVENT_MANAGER_PLUGINS_32 == (null as any))) { (this.__EVENT_MANAGER_PLUGINS_32 = [
      ...
      new import64.HammerGesturesPlugin(this._HAMMER_GESTURE_CONFIG_31)
    ]
    ); }
    return this.__EVENT_MANAGER_PLUGINS_32;
  }
  get _EventManager_33():import16.EventManager {
    if ((this.__EventManager_33 == (null as any))) { (this.__EventManager_33 = new import16.EventManager(this._EVENT_MANAGER_PLUGINS_32,this.parent.get(import65.NgZone))); }
  ...
  get _RootRenderer_37():any {
    if ((this.__RootRenderer_37 == (null as any))) { (this.__RootRenderer_37 = import66._createConditionalRootRenderer(this._DomRootRenderer_36,this.parent.get(import66.NgProbeToken,(null as any)))); }
  ...
  get _AppRootToken_53():any {
    if ((this.__AppRootToken_53 == (null as any))) { (this.__AppRootToken_53 = import67.MyApp); }
  ...
  get _GestureController_59():import32.GestureController {
    if ((this.__GestureController_59 == (null as any))) { (this.__GestureController_59 = new import32.GestureController(this._App_22)); }
    return this.__GestureController_59;
  }
  get _Keyboard_60():import33.Keyboard {
    if ((this.__Keyboard_60 == (null as any))) { (this.__Keyboard_60 = new import33.Keyboard(this._Config_21,this._Form_58,this.parent.get(import65.NgZone))); }
    return this.__Keyboard_60;
  }
  get _LoadingController_61():import34.LoadingController {
    if ((this.__LoadingController_61 == (null as any))) { (this.__LoadingController_61 = new import34.LoadingController(this._App_22)); }
    return this.__LoadingController_61;
  }
  get _LocationStrategy_62():any {
    if ((this.__LocationStrategy_62 == (null as any))) { (this.__LocationStrategy_62 = import8.provideLocationStrategy(this.parent.get(import68.PlatformLocation),this.parent.get(import69.APP_BASE_HREF,(null as any)),this._Config_21)); }
    return this.__LocationStrategy_62;
  }
  get _Location_63():import35.Location {
    if ((this.__Location_63 == (null as any))) { (this.__Location_63 = new import35.Location(this._LocationStrategy_62)); }
    return this.__Location_63;
  }
  get _MenuController_64():import36.MenuController {
    if ((this.__MenuController_64 == (null as any))) { (this.__MenuController_64 = new import36.MenuController()); }
    return this.__MenuController_64;
  }
  get _ModalController_65():import37.ModalController {
    if ((this.__ModalController_65 == (null as any))) { (this.__ModalController_65 = new import37.ModalController(this._App_22)); }
    return this.__ModalController_65;
  }
  get _PickerController_66():import38.PickerController {
    if ((this.__PickerController_66 == (null as any))) { (this.__PickerController_66 = new import38.PickerController(this._App_22)); }
    return this.__PickerController_66;
  }
  get _PopoverController_67():import39.PopoverController {
    if ((this.__PopoverController_67 == (null as any))) { (this.__PopoverController_67 = new import39.PopoverController(this._App_22)); }
    return this.__PopoverController_67;
  }
  get _TapClick_68():import40.TapClick {
    if ((this.__TapClick_68 == (null as any))) { (this.__TapClick_68 = new import40.TapClick(this._Config_21,this._App_22,this.parent.get(import65.NgZone))); }
    return this.__TapClick_68;
  }
  get _ToastController_69():import41.ToastController {
    if ((this.__ToastController_69 == (null as any))) { (this.__ToastController_69 = new import41.ToastController(this._App_22)); }
    return this.__ToastController_69;
  }
  get _Translate_70():import42.Translate {
    if ((this.__Translate_70 == (null as any))) { (this.__Translate_70 = new import42.Translate()); }
    return this.__Translate_70;
  }
  get _TransitionController_71():import43.TransitionController {
    if ((this.__TransitionController_71 == (null as any))) { (this.__TransitionController_71 = new import43.TransitionController(this._Config_21)); }
    return this.__TransitionController_71;
  }
  get _UrlSerializer_72():any {
    if ((this.__UrlSerializer_72 == (null as any))) { (this.__UrlSerializer_72 = import70.setupUrlSerializer(this._DeepLinkConfigToken_54)); }
    return this.__UrlSerializer_72;
  }
  get _DeepLinker_73():any {
    if ((this.__DeepLinker_73 == (null as any))) { (this.__DeepLinker_73 = import71.setupDeepLinker(this._App_22,this._UrlSerializer_72,this._Location_63)); }
    return this.__DeepLinker_73;
  }
  get _SpotifyService_74():import44.SpotifyService {
    if ((this.__SpotifyService_74 == (null as any))) { (this.__SpotifyService_74 = new import44.SpotifyService(this._Http_50)); }
    return this.__SpotifyService_74;
  }
  get _NativeMedia_75():import45.NativeMedia {
    if ((this.__NativeMedia_75 == (null as any))) { (this.__NativeMedia_75 = new import45.NativeMedia(this._Platform_20)); }
    return this.__NativeMedia_75;
  }
  createInternal():import1.AppModule {
    ...
    this._QueryParams_14 = import72.setupQueryParams(this._UrlToken_13);
    this._PlatformConfigToken_15 = import73.providePlatformConfigs();
    ...
    this._Platform_20 = import74.setupPlatform(this._PlatformConfigToken_15,this._QueryParams_14,this._UserAgentToken_16,this._NavigatorPlatformToken_17,this._DocumentDirToken_18,this._DocLangToken_19,this.parent.get(import65.NgZone));
    this._Config_21 = import75.setupConfig(this._ConfigToken_12,this._QueryParams_14,this._Platform_20);
    this._App_22 = new import10.App(this._Config_21,this._Platform_20);
    this._APP_INITIALIZER_23 = [
      import76.registerModeConfigs(this._Config_21),
      import77.registerTransitions(this._Config_21),
      import30.setupProvideEvents(this._Platform_20),
      import40.setupTapClick(this._Config_21,this._App_22,this.parent.get(import65.NgZone))
    ]
    ;
    this._ApplicationInitStatus_24 = new import11.ApplicationInitStatus(this._APP_INITIALIZER_23);
    this._Testability_25 = new import12.Testability(this.parent.get(import65.NgZone));
    this._ApplicationRef__26 = new import13.ApplicationRef_(this.parent.get(import65.NgZone),this.parent.get(import78.Console),this,this._ErrorHandler_11,this,this._ApplicationInitStatus_24,this.parent.get(import12.TestabilityRegistry,(null as any)),this._Testability_25);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import79.LOCALE_ID)) { return this._LOCALE_ID_9; }
    if ((token === import9.NgLocalization)) { return this._NgLocalization_10; }
    if ((token === import80.ErrorHandler)) { return this._ErrorHandler_11; }
    if ((token === import75.ConfigToken)) { return this._ConfigToken_12; }
    if ((token === import72.UrlToken)) { return this._UrlToken_13; }
    if ((token === import72.QueryParams)) { return this._QueryParams_14; }
    if ((token === import73.PlatformConfigToken)) { return this._PlatformConfigToken_15; }
    if ((token === import74.UserAgentToken)) { return this._UserAgentToken_16; }
    if ((token === import74.NavigatorPlatformToken)) { return this._NavigatorPlatformToken_17; }
    if ((token === import74.DocumentDirToken)) { return this._DocumentDirToken_18; }
    if ((token === import74.DocLangToken)) { return this._DocLangToken_19; }
    if ((token === import74.Platform)) { return this._Platform_20; }
    if ((token === import75.Config)) { return this._Config_21; }
    ...
    if ((token === import61.APP_ID)) { return this._APP_ID_29; }
    if ((token === import81.DOCUMENT)) { return this._DOCUMENT_30; }
    if ((token === import64.HAMMER_GESTURE_CONFIG)) { return this._HAMMER_GESTURE_CONFIG_31; }
    ...
    if ((token === import82.AnimationDriver)) { return this._AnimationDriver_35; }
    if ((token === import18.DomRootRenderer)) { return this._DomRootRenderer_36; }
    if ((token === import83.RootRenderer)) { return this._RootRenderer_37; }
    if ((token === import19.DomSanitizer)) { return this._DomSanitizer_38; }
    if ((token === import84.Sanitizer)) { return this._Sanitizer_39; }
    if ((token === import20.ViewUtils)) { return this._ViewUtils_40; }
    if ((token === import85.IterableDiffers)) { return this._IterableDiffers_41; }
    if ((token === import86.KeyValueDiffers)) { return this._KeyValueDiffers_42; }
    ...
    if ((token === import89.AppRootToken)) { return this._AppRootToken_53; }
    if ((token === import70.DeepLinkConfigToken)) { return this._DeepLinkConfigToken_54; }
    ...
    if ((token === import32.GestureController)) { return this._GestureController_59; }
    if ((token === import33.Keyboard)) { return this._Keyboard_60; }
    if ((token === import34.LoadingController)) { return this._LoadingController_61; }
    if ((token === import69.LocationStrategy)) { return this._LocationStrategy_62; }
    if ((token === import35.Location)) { return this._Location_63; }
    if ((token === import36.MenuController)) { return this._MenuController_64; }
    if ((token === import37.ModalController)) { return this._ModalController_65; }
    if ((token === import38.PickerController)) { return this._PickerController_66; }
    if ((token === import39.PopoverController)) { return this._PopoverController_67; }
    if ((token === import40.TapClick)) { return this._TapClick_68; }
    if ((token === import41.ToastController)) { return this._ToastController_69; }
    if ((token === import42.Translate)) { return this._Translate_70; }
    if ((token === import43.TransitionController)) { return this._TransitionController_71; }
    if ((token === import70.UrlSerializer)) { return this._UrlSerializer_72; }
    if ((token === import71.DeepLinker)) { return this._DeepLinker_73; }
    if ((token === import44.SpotifyService)) { return this._SpotifyService_74; }
    if ((token === import45.NativeMedia)) { return this._NativeMedia_75; }
