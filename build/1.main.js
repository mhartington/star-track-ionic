...
var SearchPage = (function () {
    function SearchPage(nav, spotify, loadingCtrl) {
        ...
        this.search = new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* FormControl */]();
        this.search.valueChanges
            .subscribe(function (res) { return console.log(res); }, function () { return console.log('done'); });
    }
